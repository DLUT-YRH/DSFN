...
from dataset import TrainDataset
import glob
from loss import cal_lp_loss, inter_grid_loss, intra_grid_loss, cal_depth_loss
import pandas as pd
...
#                 depthInput2_tensor = depthInput1_tensor.cuda()
...
# #             print(total_loss)
# #             print(overlap_loss)
# #             print(nonoverlap_loss)
# #             print(overlap_depth_loss)
# #             print("-----------------")
...
#         if ((epoch+1) % 50 == 0 or (epoch + 1) == 2 or (epoch+1)==args.max_epoch):
#             filename ='epoch' + str(epoch+1).zfill(3) + '_model.pth'
#             model_save_path = os.path.join(MODEL_DIR, filename)
#             state = {'model': net.state_dict(), 'optimizer': optimizer.state_dict(), 'epoch': epoch+1, "glob_iter": glob_iter}
#             torch.save(state, model_save_path)
